    ...
    if (this.state.isCardInEdit) {
      return (
        <input
          ...
          onKeyDown={this.onKeyDownCardTitleHandler}
      ...
      return (
        <React.Fragment>
          ...
          <span
            className={classes.cardtitleEditIcon}
            onClick={this.cardTitleEditIconHandler}
          >
            <EditLogo />
          </span>
        </React.Fragment>
      ...
      <Draggable draggableId={this.props.card.id} index={this.props.index}>
        {provided => (
          ...
          >
            <Backdrop
              provided={provided}
              clickedOutside={this.onCardTitleOutsideClicked}
            >
              {this.cardTitleWrapper()}
            </Backdrop>
          </div>
        )}
      </Draggable>
